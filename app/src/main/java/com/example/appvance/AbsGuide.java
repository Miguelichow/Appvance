...
/**
 * Clase que maneja la guía de ejercicios de abdomen
 * @author Miguel Prieto Horcajo
 */
public class AbsGuide extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Guía de abdomen");
        setContentView(R.layout.activity_abs_guide);
